...
my_collections.insert_many([
    ...
    },
    {
        ...
        'feed_images':["https://images.chosun.com/resizer/XdUHAMF4ZGd_4l8Ze0lyx93Z37Y=/464x0/smart/cloudfront-ap-northeast-1.images.arcpublishing.com/chosun/6UHBHL2DZ7ISPMQ5UO6XAHUYNQ.jpg"],
        'profile_img': "https://cdn.econovill.com/news/photo/201603/285365_95988_038.png",
        'content' : 'CONTENT444444444444444444444444444444444',
        'like':[
            {'nickname':'mgkim', 'date':'2020.05.10'},
        ],
        'bookmark':[
            {'nickname':'mgkim', 'date':'2020.05.10'},
        ],
        'reply':[
            {'num':1, 'nickname':'mgkim','date':'2021.07.10', 'content':'REPLY111'},
        ]
    },    
    {
        'num':'5',
        ...
        'content' : 'CONTENT5',
        'like':[
            {'nickname':'jhpark', 'date':'2020.08.05'},
            {'nickname':'mgkim', 'date':'2020.07.06'}
        ],
        'bookmark':[
            {'nickname':'jhpark', 'date':'2020.08.05'},
            {'nickname':'mgkim', 'date':'2020.07.06'}
        ...
        'reply':[
            {'num':1, 'nickname':'mgkim','date':'2022.07.14', 'content':'REPLY111reply111'},
            {'num':2, 'nickname':'smkim','date':'2022..07.15', 'content':'REPLY222reply222'},
            {'num':3, 'nickname':'jhpark','date':'2022.07.16', 'content':'REPLY333reply333'}
        ]
    },
    {
        'num':'6',
